...
jmeno=input("Prosím , zadejte Vaše jmeno: ")
heslo=input("Prosím , zadejte Vaše  heslo: ")
print("------------------------------------------")

vse_jmena=["bob", "ann", "mike", "liz"]
vse_hesla=("123", "pass123", "password123", "pass123")
par_vlozen={"bob":"123","ann":"pass123", "mike":"password123", "liz":"pass123"}

if jmeno in vse_jmena:
    heslo_1=par_vlozen.get(jmeno)
    if heslo_1 == heslo:
        ...
        if vyber_textu == "1" or vyber_textu == "2" or vyber_textu == "3":
            if vyber_textu == "1" :
               ...
               mala = 0
               indexM = 0
               for hodnota_7 in TEXTS[0].split() : 
               ...
               print("     1|" , "*" * pocet_1, " "*(14-pocet_1), "|",pocet_1, end="\n")  
               print("     2|" , "*" * pocet_2, " "*(14-pocet_2), "|",pocet_2, end="\n")
               print("     3|" , "*" * pocet_3, " "*(14-pocet_3), "|",pocet_3, end="\n")
               print("     4|" , "*" * pocet_4, " "*(14-pocet_4),"|",pocet_4, end="\n")
               print("     5|" , "*" * pocet_5, " "*(14-pocet_5),"|",pocet_5, end="\n")
               print("     6|" , "*" * pocet_6, " "*(14-pocet_6),"|",pocet_6, end="\n")
               print("     7|" , "*" * pocet_7, " "*(14-pocet_7),"|",pocet_7, end="\n")
               print("     8|" , "*" * pocet_8, " "*(14-pocet_8),"|",pocet_8, end="\n")
               print("     9|" , "*" * pocet_9, " "*(14-pocet_9),"|",pocet_9, end="\n")
               print("    10|" , "*" * pocet_10," "*(14-pocet_10),"|",pocet_10, end="\n")
               print("    11|" , "*" * pocet_11," "*(14-pocet_11),"|",pocet_11, end="\n")
               print("    12|" , "*" * pocet_12," "*(14-pocet_12),"|",pocet_12, end="\n")
                
                
    
            elif vyber_textu == "2" :
                hodnota_1=len(TEXTS[1].split())
                print(f"There are {hodnota_1} words in the selected text.") 
                
                x = list(TEXTS[1])
                hodnota=TEXTS[1].split()
                V = 0
                index = 0
                for hodnota_1 in hodnota : 
                    hodnota_2=(hodnota[index]. istitle()) 
                    if hodnota_2 is True :
                        V=V+1
                        index+=1
                    else:
                        index+=1
                ...
                mala = 0
                indexM = 0
                for hodnota_7 in TEXTS[1].split() : 
                    hodnota_8=(TEXTS[1][indexM].islower()) 
                    if hodnota_8 is True :
                        mala=mala+1
                        indexM+=1
                    else:
                ...
                hodnota_1=len(TEXTS[2].split())
                print(f"There are {hodnota_1} words in the selected text.") 
               
                x = list(TEXTS[2])
                hodnota=TEXTS[2].split()
                V = 0
                index = 0
                for hodnota_1 in hodnota : 
                    hodnota_2=(hodnota[index]. istitle()) 
                ...
                mala = 0
                indexM = 0
                for hodnota_7 in TEXTS[2].split() : 
                    hodnota_8=(TEXTS[2][indexM].islower()) 
                    if hodnota_8 is True :
                        mala=mala+1
                        indexM+=1
                    else:
            ...
            print("$ python projekt1.py","\n"f"username : {jmeno}""","\n"f"password : {heslo}""","\nentered text number is wrong, terminating  the  program ..." )
